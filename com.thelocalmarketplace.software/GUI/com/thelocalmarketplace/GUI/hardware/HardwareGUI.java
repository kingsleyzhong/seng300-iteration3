 ...
 * Can support drag and drop to move items between cart, scanning area, and bagging area.
...
public class HardwareGUI {
	...
	public JList<ItemObject> cartList = new JList<>(itemsInCart);
	public JList<ItemObject> scanningList= new JList<>(itemsInScanningArea);
	public JList<ItemObject> baggingList = new JList<>(itemsInBaggingArea);
	...
	public HardwareGUI(AbstractSelfCheckoutStation scs, AttendantStation supervisor) {
		...
		hardwareFrame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
		hardwareFrame.getContentPane().setBackground(Colors.color1);
		hardwareFrame.setExtendedState(Frame.MAXIMIZED_BOTH);
	...
	public class ListTransferHandler extends TransferHandler {
		...
		public boolean canImport(TransferHandler.TransferSupport info) {
            ...
            if (!info.isDataFlavorSupported(ItemObject.flavor)) return false;
