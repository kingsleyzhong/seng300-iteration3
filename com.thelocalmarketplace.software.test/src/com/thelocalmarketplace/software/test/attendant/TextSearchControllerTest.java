...
/**
 * <p>
 * A class of unit tests that test specifically the funtionality of
 * com.thelocalmarketplace.software.attendant.TextSearchController; it must be
 * able to take key inputs properly into
 * a search field and then exeute a successful search either returning all valid
 * search hits or nothing if there
 * aren't any.
 * </p>
 * <p>
 * </p>
